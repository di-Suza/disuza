...
BullMQ workers are active for destructive cleanup, background maintenance, and queued post media processing.
...
- post upload processing lets heavy media uploads continue in the background while realtime progress updates keep the feed UI responsive.
