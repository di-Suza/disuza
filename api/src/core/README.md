...
`core` contains provider-neutral product contracts that can be reused by HTTP routes, future socket handlers, and future workers.
...
- `events`: durable domain event shapes for future notification, socket, and worker fan-out.
