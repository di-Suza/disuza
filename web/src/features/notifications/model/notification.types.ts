...
export type NotificationType = 'LIKE' | 'FOLLOW' | 'COMMENT' | 'COMMENT_REPLY' | 'COLLAB_REQUEST' | 'COLLAB_ACCEPTED';
export type NotificationTargetModel = 'Post' | 'User' | 'Comment' | 'CollabRequest' | 'CollabRoom';
...
export type NotificationContent = Pick<Post, '_id' | 'caption' | 'media'> | NotificationSender | NotificationCommentContent | string | null;
