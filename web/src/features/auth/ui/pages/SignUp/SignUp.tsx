    ...
    <>
      <main className="auth-page">
        ...
        <div className="auth-layout auth-layout--signup">
          <ErrorBoundary
            variant="section"
            title="Sign up form could not be rendered."
            showReload={false}
          >
                ...
                <label className="field">
                  ...
                  <div className="field__control">
                    ...
                    <Input
                      autoComplete="new-password"
                      className={
                        showPasswordMismatch ? "input--error" : undefined
                      }
                  ...
                  {showPasswordMismatch && (
                    <p className="form-error">Passwords did not match.</p>
                  )}
                </label>
          ...
          <ErrorBoundary
            variant="section"
            title="Sign up overview could not be rendered."
            showReload={false}
          >
            <section
              className="auth-story"
              aria-label="Disuza sign up overview"
            >
              ...
              <p>
                Share posts, collect feedback, track contributions, and open
                collaborative rooms from the conversations that matter.
              </p>
              <div className="auth-feature-grid">
                {signUpFeatures.map(({ icon: Icon, title }) => (
                  <article
                    className="auth-feature auth-feature--compact"
                    key={title}
                  >
      ...
      <ErrorBoundary
        variant="inline"
        title="OTP modal could not be rendered."
        resetKeys={[isOtpVerificationModalOpen]}
        showReload={false}
      >
